...
export default function LoginScreenPassword({ navigation }) {
        ...
        <View style={styles.benefitsWrapper}>
            ...
            <View style={styles.registerWrapper}>
                <ScrollView style={styles.scrollViewElement}>
                    ...
                    <Text style={styles.header}>Въвеждане на парола</Text>
                    <InputText icon="password" placeholder="Парола" />
                    <PurpleButton onPress={() => navigation.navigate('ForgottenPassword')} buttonState="active" title="Продължи" />
