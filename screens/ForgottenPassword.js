        ...
        <View style={styles.benefitsWrapper}>
            ...
            <View style={styles.registerWrapper}>
                <ScrollView style={styles.scrollViewElement}>
                    ...
                    <Text style={styles.header}>Генериране на нова парола</Text>
                    <Text style={styles.alreadyMember}>Моля, въведете мейл адрес, на който ще получите код за потвърждение.</Text>
                    <InputText icon="email" placeholder="Имейл" />
                    <PurpleButton onPress={() => navigation.navigate('CreatePassword')} buttonState="active" title="Продължи" />
